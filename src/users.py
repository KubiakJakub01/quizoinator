...
users = Blueprint(
    "users", __name__, template_folder=template_folder, static_folder=static_folder
)
relationship_utils = RelationshipUtils(db, Users, Relationship)
user_utils = UserUtils(db, Users, images_dir)
